...
const CourseInfoCard = ({ selectedCourse }) => {
  ...
  // ** render user img
  const renderUserImg = () => {
    if (selectedCourse?.imageAddress?.length) {
      return (
        <img
          height='110'
          width='110'
            ...
            <div className='d-flex align-items-center flex-column'>
              ...
              <div className='d-flex flex-column align-items-center text-center'>
                <div className='user-info'>
                  <h4>{selectedCourse !== null ? `${selectedCourse?.title}` : 'Eleanor Aguilar'}</h4>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className='info-container'>
            {selectedCourse !== null ? (
              <ul className='list-unstyled'>
                ...
                <li className='mb-75'>
                  <span className='fw-bolder me-25 fs-4'>نام استاد:</span>
                ...
                <li className='mb-75'>
                  <span className='fw-bolder me-25 fs-4'>ظرفیت:</span>
