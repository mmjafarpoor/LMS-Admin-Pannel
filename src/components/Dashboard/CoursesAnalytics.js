  ...
  return data !== null ? (
    <Card>
      ...
      <CardBody className='p-0'>
        <div className='fs-3 text-center mb-0.5' tag='h4'>درصد تایید شده‌ها</div>
        <Chart options={options} series={series} type='radialBar' height={245} />
      </CardBody>
      <Row className='border-top text-center mx-0'>
        <Col xs='4' className='border-end py-1'>
          <CardText className='text-muted mb-0'>رزروها</CardText>
          <h3 className='fw-bolder mb-0'>{data.completed}</h3>
        </Col>
        <Col xs='4' className='border-end py-1'>
          <CardText className='text-muted mb-0'>رزروهای تایید شده</CardText>
          <h3 className='fw-bolder mb-0'>{data.inProgress}</h3>
        </Col>
        <Col xs='4' className='py-1'>
          <CardText className='text-muted mb-0'>رزروهای تایید نشده</CardText>
          <h3 className='fw-bolder mb-0'>{data.inProgress}</h3>
        </Col>
      </Row>
    </Card>
